...
<body style="background-color: #26262d">
            ...
            <div class="collapse navbar-collapse" id="navbarCollapse">
                <ul class="navbar-nav mr-auto">
                    <li class="nav-item active">
                        <a class="nav-link" href="http://localhost/movies_/">Home <span
                ...
                <ul class="navbar-nav ml-auto">
                    <li class="nav-item active btn-signup">
                        <a class="nav-link" href="http://localhost/movies_/#" style="color:black !important;">Sign Up
    ...
    <div id="myCarousel" class="carousel slide" data-ride="carousel"
        style="height: 374px; overflow: hidden;background-size:cover">
            ...
            <div class="carousel-item">
                ...
                <div class="container">
                    <div class="carousel-caption text-left">
                        ...
                        <p><a class="btn btn-lg btn-primary" href="http://localhost/movies_/#" role="button">Watch
                                Now</a></p>
                    </div>
                </div>
            </div>
        ...
        <div class="container marketing">
            ...
            <div class="row">
                <div class="col-sm-12" style="text-align:center;margin-top:10px">
                    <nav aria-label="" class="pagination-centered"
                        style="display: inline-block; background-color:inherit">
